...
const CommingSoon = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Coming Soon - HR Analytics Mirror</title>
        <meta
          name="description"
          content="Coming Soon - HR Analytics Mirror. We’re building something powerful and meaningful. Stay tuned for the next experience from HR Analytics-Mirror."
        />
      </Helmet>
      <section
        className="
          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-sm leading-6 text-gray-500">
                Better tools, deeper insights, and smarter experiences are on
                the way.
              </p>
            </motion.div>
