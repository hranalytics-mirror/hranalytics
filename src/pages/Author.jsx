...
import prarthana from "../assets/prathana.webp";
...
const Author = () => {
  return (
    <>
      <Helmet>
        <title>HR Analytics Mirror Authors</title>

        <meta
          name="description"
          content="About the authors of HR Analytics Mirror – Prarthana Karmakar and Abhishek Shrivastava."
        />
      </Helmet>
            ...
            <div className="grid items-center gap-10 p-6 md:p-10 lg:grid-cols-2">
              ...
              >
                ...
                <div className="mt-8 space-y-5 leading-8 text-gray-600">
                  ...
                  <p>
                    Through The HR Mirror 500 series, Abhinandan transforms
                    years of practical experience into actionable frameworks for
